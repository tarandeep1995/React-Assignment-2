      ...
      <section className="filter">
        <div className="categorycontainer">
          ...
          <ul>
            ...
            <li>
              <a href="#2">Artificial Intelligence</a>
            </li>
            <li>
              <a href="#1">Cloud Computing</a>
            </li>
            <li>
              <a href="#1">DevOps</a>
            </li>
            <li>
              <a href="#1">Programming Languages</a>
            </li>
            <li>
              <a href="#1">Mobile Application Development</a>
            </li>
            <li>
              <a href="#1">Technology and Tools</a>
            </li>
            <li>
              <a href="#1">Get a Job in a Tech Company</a>
            </li>
            <li>
              <a href="#1">Others</a>
            </li>
